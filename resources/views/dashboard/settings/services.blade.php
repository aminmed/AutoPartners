                            ...
                            <form class="form" method="post" data-url="{{ $data['route'] }}">
                                ...
                                <div class="form-group" id="home">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="checkbox" class="switch" data-off-label="Non" data-on-label="Oui" name="services[home]" {{ $data['services']['home'] == 'yes' ? 'checked' : 'unchecked' }} />
                                    </div>
                                </div>
                                <div class="form-group" id="services_title">
                                    <label>Titre de la section </label>
                                    <div class="position-relative has-icon-left">
                                        <input type="text" class="form-control" id="services_title" name="services[title]" value="{{ $data['services']['title'] }}">
                                        <div class="form-control-position">
                                            <i class="fa fa-paragraph"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="services_description">
                                    <label> Description </label>
                                    <div class="position-relative has-icon-left">
                                        <textarea id="services_description" name="services[sub_title]" class="form-control" rows="5">{{ $data['services']['sub_title'] }}</textarea>
                                        <div class="form-control-position">
