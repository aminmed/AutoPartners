                            ...
                            <form class="form" method="post" data-url="{{ $data['route'] }}">
                                ...
                                <div class="form-group" id="home">
                                    ...
                                    <div class="position-relative has-icon-left">
                                        <input type="checkbox" class="switch" data-off-label="Non" data-on-label="Oui" name="testimonial[home]" {{ $data['testimonial']['home'] == 'yes' ? 'checked' : '' }} />
                                    </div>
                                </div>
                                <div class="form-group" id="testimonial_title">
                                    <label>Titre de la section </label>
                                    <div class="position-relative has-icon-left">
                                        <input type="text" class="form-control" id="testimonial_title" name="testimonial[title]" value="{{ $data['testimonial']['title'] }}">
                                        <div class="form-control-position">
                                            <i class="fa fa-paragraph"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="testimonial_description">
                                    <label> Description </label>
                                    <div class="position-relative has-icon-left">
                                        <textarea id="testimonial_description" name="testimonial[sub_title]" class="form-control" rows="5">{{ $data['testimonial']['sub_title'] }}</textarea>
                                        <div class="form-control-position">
