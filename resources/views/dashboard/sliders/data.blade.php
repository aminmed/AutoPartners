            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control search" id="focus_field" value="{{ $data['search'] }}" placeholder="key words" autofocus="" autocomplete="off">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label><p></p></label>
                        <select class="form-control btn-primary" id="urlSelect">
                            <option data-url="{{ $data['route'] }}?orderKey={{ $data['orderKey'] }}&orderBy=asc&search={{ $data['search'] }}" {{ $data['orderBy'] == "asc" ? "selected" : "" }}>ascending</option>
                            <option data-url="{{ $data['route'] }}?orderKey={{ $data['orderKey'] }}&orderBy=desc&search={{ $data['search'] }}" {{ $data['orderBy'] == "desc" ? "selected" : "" }}>descending</option>
                        </select>
                    </div>
                </div>
