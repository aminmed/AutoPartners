                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li class="active"><a href="{{url('/cars')}}">Nos vehicules</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="car-details-content">
                        <h2>{{$car->title}} <span class="price">Prix: <b>{{$car->prix}} £</b></span></h2>
                    ...
                    <div class="sidebar-content-wrap m-t-50">
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <p><i class="fa fa-mobile"></i> {{$settings['contact']['phone'] }} </p>
                                <p><i class="fa fa-clock-o"></i> {{$settings['contact']['openning'] }}</p>
                            </div>
                        </div>
                        <!-- Single Sidebar End -->
                        <!-- Single Sidebar Start -->
